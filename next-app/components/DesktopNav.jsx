...
export default function DesktopNav(props) {
    ...
    if (window.innerHeight < 900) {
        return <div className={classes.smallNav}>
            <img src="/menu.svg" alt="Menu" />
            {window.innerWidth > 500 ? <div className={classes.mobNavLogo}><img src="/fan.svg" height={20} width={20} />
                <div>Linney CMS</div></div> : null}
            <div>
                <div>
                    <div className={classes.smallNavName}>{name}</div>
                    <div className={classes.smallNavOrg}>Organisation</div>
                </div>
